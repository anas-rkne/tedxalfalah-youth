      ...
      >
        ...
        >
          ...
          <div className="relative z-10 text-center">
            <span
              className={`font-bold text-zinc-300 uppercase tracking-[0.15em] group-hover:text-[#e62b1e] transition-colors duration-500 ${
          ...
          <div className="relative z-10 text-center">
            <span
              className={`text-zinc-500 group-hover:text-zinc-700 transition-colors duration-300 ${
                sponsor.tier === "platinum" ? "text-sm sm:text-base font-semibold" : "text-xs sm:text-sm"
              } ${isArabic ? "font-arabic" : ""}`}
            >
              {isArabic ? sponsor.nameAr : sponsor.name}
            </span>
          </div>
