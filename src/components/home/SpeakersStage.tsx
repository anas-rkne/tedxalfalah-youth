      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto">
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <h2 className="heading-h1 tracking-[-0.03em] mb-3 text-center">{heading}</h2>
            <p className="text-muted-foreground text-base max-w-md mx-auto leading-[1.7]">{subtitle}</p>
          </div>
        </ScrollReveal>
